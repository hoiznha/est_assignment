...
- **Hallucination 방지**: 오직 **제공된 Q&A.xlsx 데이터셋의 답변**만을 유사도 검색으로 추출하여 챗봇 응답으로 사용합니다.
- **임베딩 전략 최적화**: BGE 모델의 Query/Passage 프리픽스를 활용하고, '질문-질문 매칭' 방식으로 검색 정확도를 극대화했습니다.
...
**최적화 기법:**
- **INT8 양자화 적용**: BGE-m3-ko 모델 로딩 시 `torch_dtype=torch.int8`을 적용하여 모델의 RAM 사용량 약 1/4배 감소 및 OOM 에러 방지
